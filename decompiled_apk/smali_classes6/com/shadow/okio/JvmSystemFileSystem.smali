.class public Lcom/shadow/okio/JvmSystemFileSystem;
...
.method private final list(Lcom/shadow/okio/Path;Z)Ljava/util/List;
    ...
    .line 2
    invoke-virtual {p1}, Lcom/shadow/okio/Path;->toFile()Ljava/io/File;
    ...
    invoke-virtual {p1, v3}, Lcom/shadow/okio/Path;->resolve(Ljava/lang/String;)Lcom/shadow/okio/Path;
    ...
    .line 14
    :cond_3
    invoke-static {p2}, Landroidx/base/환경;->n(Ljava/util/ArrayList;)V

    return-object p2
.end method

.method private final requireCreate(Lcom/shadow/okio/Path;)V
    .locals 2

    .line 1
    invoke-virtual {p0, p1}, Lcom/shadow/okio/FileSystem;->exists(Lcom/shadow/okio/Path;)Z
...
.method private final requireExist(Lcom/shadow/okio/Path;)V
    .locals 2
...
.method public appendingSink(Lcom/shadow/okio/Path;Z)Lcom/shadow/okio/Sink;
    ...
    .line 7
    .line 8
    invoke-direct {p0, p1}, Lcom/shadow/okio/JvmSystemFileSystem;->requireExist(Lcom/shadow/okio/Path;)V
    ...
    .line 16
    invoke-static {p1, p2}, Lcom/shadow/okio/Okio;->sink(Ljava/io/File;Z)Lcom/shadow/okio/Sink;
...
.method public atomicMove(Lcom/shadow/okio/Path;Lcom/shadow/okio/Path;)V
    ...
    .line 15
    invoke-virtual {p2}, Lcom/shadow/okio/Path;->toFile()Ljava/io/File;
...
.method public canonicalize(Lcom/shadow/okio/Path;)Lcom/shadow/okio/Path;
    ...
    .line 25
    invoke-static {v0, p1, v3, v1, v2}, Lcom/shadow/okio/Path$Companion;->get$default(Lcom/shadow/okio/Path$Companion;Ljava/io/File;ZILjava/lang/Object;)Lcom/shadow/okio/Path;
...
.method public createDirectory(Lcom/shadow/okio/Path;Z)V
    ...
    .line 15
    .line 16
    invoke-virtual {p0, p1}, Lcom/shadow/okio/JvmSystemFileSystem;->metadataOrNull(Lcom/shadow/okio/Path;)Lcom/shadow/okio/FileMetadata;
...
.method public list(Lcom/shadow/okio/Path;)Ljava/util/List;
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Lcom/shadow/okio/JvmSystemFileSystem;->list(Lcom/shadow/okio/Path;Z)Ljava/util/List;
...
.method public metadataOrNull(Lcom/shadow/okio/Path;)Lcom/shadow/okio/FileMetadata;
    ...
    .line 48
    :cond_0
    new-instance p1, Lcom/shadow/okio/FileMetadata;
...
.method public openReadOnly(Lcom/shadow/okio/Path;)Lcom/shadow/okio/FileHandle;
    ...
    .line 5
    .line 6
    new-instance v0, Lcom/shadow/okio/JvmFileHandle;
    ...
    .line 20
    invoke-direct {v0, p1, v1}, Lcom/shadow/okio/JvmFileHandle;-><init>(ZLjava/io/RandomAccessFile;)V
...
.method public openReadWrite(Lcom/shadow/okio/Path;ZZ)Lcom/shadow/okio/FileHandle;
    ...
    .line 20
    .line 21
    invoke-direct {p0, p1}, Lcom/shadow/okio/JvmSystemFileSystem;->requireCreate(Lcom/shadow/okio/Path;)V
    ...
    .line 29
    :cond_3
    new-instance p2, Lcom/shadow/okio/JvmFileHandle;
    ...
    .line 43
    invoke-direct {p2, p1, p3}, Lcom/shadow/okio/JvmFileHandle;-><init>(ZLjava/io/RandomAccessFile;)V
...
.method public sink(Lcom/shadow/okio/Path;Z)Lcom/shadow/okio/Sink;
    ...
    .line 18
    invoke-static {p1, v1, p2, v0}, Lcom/shadow/okio/Okio;->sink$default(Ljava/io/File;ZILjava/lang/Object;)Lcom/shadow/okio/Sink;
