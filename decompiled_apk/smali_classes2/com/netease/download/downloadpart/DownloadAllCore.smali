...
.method private download_core(Lcom/netease/download/downloader/DownloadParams;Lcom/netease/download/Const$Stage;I)I
    ...
    const-string v14, "DownloadAllCore [download_core] \u76ee\u5f55\u5f02\u5e38\uff0c\u65e0\u6cd5\u8ba1\u7b97\uff0c md5="

    const-string v15, "DownloadAllCore [download_core] \u7a7a\u95f4\u4e0d\u8db3\uff0c md5="

    const-string v11, "[ORBIT] Downfile not space"
    ...
    invoke-direct {v1, v12, v13}, Lcom/netease/download/downloadpart/DownloadAllCore;->setTotalFileSize(J)V
    ...
    invoke-static {v0, v12, v13, v7, v8}, Lcom/netease/download/storage/StorageUtil;->canStore(Ljava/lang/String;JD)I
    ...
    .line 456
    invoke-static {v6, v11}, Lcom/netease/download/util/LogUtil;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_1
    const-string/jumbo v12, "\u83b7\u53d6\u6587\u4ef6\u5927\u5c0f"

    .line 473
    invoke-static {v12}, Lcom/netease/download/util/LogUtil;->stepLog(Ljava/lang/String;)V
    ...
    const-string/jumbo v13, "\u83b7\u53d6\u5927\u5c0f\uff0c\u8bf7\u6c42\u7684header \u8bf7\u6c42\u94fe\u63a5="
    ...
    invoke-static {v6, v12}, Lcom/netease/download/util/LogUtil;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v12, v5}, Lcom/netease/download/httpdns/HttpdnsProxy;->containKey(Ljava/lang/String;)Z
    ...
    :try_start_2
    const-string v12, "DownloadAllCore [\u8bf7OkHttpProxy [execute_syn] headers =\u6c42\u6587\u4ef6\u5927\u5c0f] \u4f7f\u7528 dns ip"
    ...
    invoke-virtual {v12, v10}, Lcom/netease/download/dns/CdnIpController;->hasNextUnit(Ljava/lang/String;)Z

    move-result v10

    if-eqz v10, :cond_d

    const-string v10, "\u5207\u6362\u4e0b\u4e00\u4e2ahost"
    ...
    invoke-virtual {v10, v12}, Lcom/netease/download/dns/CdnIpController;->nextUnit(Ljava/lang/String;)Lcom/netease/download/dns/CdnIpController$CndIpControllerUnit;
    ...
    invoke-virtual {v12, v10}, Lcom/netease/download/dns/CdnIpController;->hasNextIp(Ljava/lang/String;)Z
    ...
    invoke-virtual {v12, v10}, Lcom/netease/download/dns/CdnIpController;->nextIp(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "\u4e0b\u8f7d\u6587\u4ef6\u5927\u5c0f\u7684\u57df\u540d host="
    ...
    const-string v1, ", pParams.getDownloadUrl()="

    invoke-virtual {v3, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v12}, Lcom/netease/download/downloader/DownloadParams;->getDownloadUrl(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Lcom/netease/ntunisdk/okhttp3/Request$Builder;->url(Ljava/lang/String;)Lcom/netease/ntunisdk/okhttp3/Request$Builder;

    move-result-object v1

    .line 496
    invoke-virtual {v1, v7, v10}, Lcom/netease/ntunisdk/okhttp3/Request$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lcom/netease/ntunisdk/okhttp3/Request$Builder;

    .line 499
    invoke-virtual {v1}, Lcom/netease/ntunisdk/okhttp3/Request$Builder;->head()Lcom/netease/ntunisdk/okhttp3/Request$Builder;

    .line 500
    invoke-virtual {v1, v8, v13}, Lcom/netease/ntunisdk/okhttp3/Request$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lcom/netease/ntunisdk/okhttp3/Request$Builder;
    ...
    invoke-virtual {v3, v1, v0}, Lcom/netease/download/network/OkHttpProxy;->execute_syn(Lcom/netease/ntunisdk/okhttp3/Request$Builder;Lcom/netease/ntunisdk/okhttp3/Callback;)I
    ...
    :cond_f
    :try_start_6
    const-string v1, "DownloadAllCore [\u8bf7\u6c42\u6587\u4ef6\u5927\u5c0f] \u4f7f\u7528\u5907\u7528ip"
    ...
    invoke-virtual {v2, v1}, Lcom/netease/download/downloader/DownloadParams;->getDownloadUrl(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v10, v12}, Lcom/netease/ntunisdk/okhttp3/Request$Builder;->url(Ljava/lang/String;)Lcom/netease/ntunisdk/okhttp3/Request$Builder;

    move-result-object v10

    .line 509
    invoke-virtual {v10, v7, v3}, Lcom/netease/ntunisdk/okhttp3/Request$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lcom/netease/ntunisdk/okhttp3/Request$Builder;

    .line 512
    invoke-virtual {v10}, Lcom/netease/ntunisdk/okhttp3/Request$Builder;->head()Lcom/netease/ntunisdk/okhttp3/Request$Builder;

    .line 513
    invoke-virtual {v10, v8, v13}, Lcom/netease/ntunisdk/okhttp3/Request$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lcom/netease/ntunisdk/okhttp3/Request$Builder;
    ...
    invoke-virtual {v7, v10, v0}, Lcom/netease/download/network/OkHttpProxy;->execute_syn(Lcom/netease/ntunisdk/okhttp3/Request$Builder;Lcom/netease/ntunisdk/okhttp3/Callback;)I
    ...
    :try_start_9
    const-string v1, "DownloadAllCore [\u8bf7\u6c42\u6587\u4ef6\u5927\u5c0f] \u4f7f\u7528 httpdns ip"
    ...
    const-string/jumbo v3, "\u83b7\u53d6\u6587\u4ef6\u5927\u5c0f\u7684\u8fd4\u56de\u7801="
    ...
    invoke-static {v1, v12, v13, v7, v8}, Lcom/netease/download/storage/StorageUtil;->canStore(Ljava/lang/String;JD)I
    ...
    const-string v8, "DownloadAllCore [download_core] params size()="
    ...
    const-string v8, ", getTotalFileSize()="
    ...
    const-string v7, "DownloadAllCore [download_core] CdnIpController.getInstances().hasNextIp(host)="
    ...
    invoke-virtual {v7, v10}, Lcom/netease/download/dns/CdnIpController;->hasNextIp(Ljava/lang/String;)Z
    ...
    const-string v7, "DownloadAllCore [download_core] CdnIpController.getInstances().hasNextUnit()="
    ...
    invoke-virtual {v1, v10}, Lcom/netease/download/dns/CdnIpController;->hasNextIp(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v7}, Lcom/netease/download/dns/CdnIpController;->hasNextUnit(Ljava/lang/String;)Z
    ...
    const-string v3, "DownloadAllCore [download_core] [\u8bf7\u6c42\u6587\u4ef6\u5927\u5c0f] overSea="
    ...
    const-string v3, "DownloadAllCore [\u8bf7\u6c42\u6587\u4ef6\u5927\u5c0f\uff0chttpdns] \u662f\u5426\u5df2\u7ecf\u89e3\u6790\u8fc7httpdns_config_cnd = "
    ...
    invoke-virtual {v1, v5, v3}, Lcom/netease/download/httpdns/HttpdnsProxy;->synStart(Ljava/lang/String;Ljava/util/Map;)V
    ...
    const-string v7, "DownloadAllCore [\u8bf7\u6c42\u6587\u4ef6\u5927\u5c0f\uff0chttpdns] httpdns\u5220\u9664\u524d\u96c6\u5408="
    ...
    invoke-virtual {v1, v3}, Lcom/netease/download/UrlSwitcher/HttpdnsUrlSwitcherCore$KeyHttpdnsUrlSwitcherCoreUnit;->next(Ljava/lang/String;)Lcom/netease/download/UrlSwitcher/HttpdnsUrlSwitcherCore$HttpdnsUrlSwitcherCoreUnit;
    ...
    .line 604
    iget-object v7, v3, Lcom/netease/download/UrlSwitcher/HttpdnsUrlSwitcherCore$HttpdnsUrlSwitcherCoreUnit;->ip:Ljava/lang/String;

    invoke-virtual {v1, v7}, Lcom/netease/download/UrlSwitcher/HttpdnsUrlSwitcherCore$KeyHttpdnsUrlSwitcherCoreUnit;->remove(Ljava/lang/String;)V
    ...
    const-string v7, "DownloadAllCore [\u8bf7\u6c42\u6587\u4ef6\u5927\u5c0f\uff0chttpdns] \u5220\u9664ip="
    ...
    const-string v3, "DownloadAllCore [\u8bf7\u6c42\u6587\u4ef6\u5927\u5c0f\uff0chttpdns] \u5373\u5c06\u4f7f\u7528\u7684host="

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, v1, Lcom/netease/download/UrlSwitcher/HttpdnsUrlSwitcherCore$HttpdnsUrlSwitcherCoreUnit;->host:Ljava/lang/String;

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v3, ",  \u5373\u5c06\u4f7f\u7528\u7684ip="
    ...
    .line 622
    iget-boolean v3, v1, Lcom/netease/download/downloadpart/DownloadAllCore;->mIsUseHistoryTopSpeedIp:Z
    ...
    const-string v8, "DownloadAllCore [\u8bf7\u6c42\u6587\u4ef6\u5927\u5c0f\uff0chttpdns] \u4f7f\u7528\u5907\u7528ip, host="
    ...
    .line 630
    invoke-virtual {v2, v3}, Lcom/netease/download/downloader/DownloadParams;->setmHttpdnsIp(Ljava/lang/String;)V
    ...
    const-string v8, "DownloadAllCore [\u8bf7\u6c42\u6587\u4ef6\u5927\u5c0f] \u4f7f\u7528\u5907\u7528ip, host="
    ...
    invoke-virtual {v0, v10, v3}, Lcom/netease/download/dns/CdnIpController;->removeIp(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3}, Lcom/netease/download/dns/CdnIpController;->hasNextUnit(Ljava/lang/String;)Z
    ...
    const-string v3, "DownloadAllCore [download_core] \u79fb\u9664cdn\uff0chost\uff1a"
    ...
    const-string v3, "DownloadAllCore [download_core] \u5269\u4f59CDN-IP\u603b\u89c8="
    ...
    invoke-direct {v1, v2, v10, v11}, Lcom/netease/download/downloadpart/DownloadAllCore;->produceSegmentParams(Lcom/netease/download/downloader/DownloadParams;J)[Lcom/netease/download/downloader/DownloadParams;
    ...
    sput-wide v7, Lcom/netease/download/downloadpart/DownloadAllCore;->mUseTime:J
    ...
    invoke-virtual {v0, v7, v5, v4}, Lcom/netease/download/downloadpart/DonwonloadPartProxy;->init([Lcom/netease/download/downloader/DownloadParams;Lcom/netease/download/Const$Stage;I)V
    ...
    .line 706
    iget-object v4, v1, Lcom/netease/download/downloadpart/DownloadAllCore;->mCheckTime:Lcom/netease/download/check/CheckTime;

    invoke-virtual/range {p1 .. p1}, Lcom/netease/download/downloader/DownloadParams;->getSize()J

    move-result-wide v7

    invoke-virtual {v4, v7, v8}, Lcom/netease/download/check/CheckTime;->mark(J)V

    .line 707
    iget-object v4, v1, Lcom/netease/download/downloadpart/DownloadAllCore;->mCheckTime:Lcom/netease/download/check/CheckTime;

    invoke-virtual {v4}, Lcom/netease/download/check/CheckTime;->calculate()Lcom/netease/download/check/CheckTime;
    ...
    check-cast v4, Lcom/netease/download/downloader/FileHandle;
    ...
    .line 721
    invoke-direct {v1, v5}, Lcom/netease/download/downloadpart/DownloadAllCore;->mergeFiles(Ljava/io/File;)Z
    ...
    invoke-virtual {v3}, Lcom/netease/download/downloader/TaskHandleOp;->addTaskFileEnterDownloadProcessCoreSuccessCount()V
    ...
    const-string/jumbo v7, "\u6ca1\u6709\u8bbe\u7f6eNotMD5\uff0c \u9700\u8981\u8fdb\u884cmd5\u68c0\u9a8c, \u6587\u4ef6\u540d\u5b57="
    ...
    const-string/jumbo v7, "\u8ba1\u7b97\u5408\u5e76\u6587\u4ef6\u7684md5, \u5408\u5e76\u540e\u7684\u6587\u4ef6\u8def\u5f84="
    ...
    invoke-static {v3, v7}, Lcom/netease/download/util/HashUtil;->calculateFileHash(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v5, v7, v9, v8}, Lcom/netease/download/util/SpUtil;->setString(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string/jumbo v7, "\u8bbe\u7f6e\u4e86NotMD5\uff0c \u9700\u8981\u8fdb\u884c\u6587\u4ef6\u5927\u5c0f\u68c0\u9a8c, \u6587\u4ef6\u540d\u5b57="
    ...
    :cond_30
    const-string v5, "DownloadAllCore [download_core] [\u5185\u5b58\u56de\u8c03\u6a21\u5f0f] \u8ba1\u7b97md5\u90e8\u5206"
    ...
    .line 821
    invoke-virtual {v4}, Lcom/netease/download/downloader/FileHandle;->getDownloadParams()Lcom/netease/download/downloader/DownloadParams;
    ...
    invoke-static {v8, v5}, Lcom/netease/download/util/HashUtil;->calculateFileHash(Ljava/lang/String;[B)Ljava/lang/String;
    ...
    const-string v9, "DownloadAllCore [download_core] [\u5185\u5b58\u56de\u8c03\u6a21\u5f0f] \u63a5\u5165\u65b9\u4f20\u5165\u7684md5="
    ...
    const-string v9, ", \u5185\u5b58\u5185\u5bb9\u7684md5="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v9, ", \u5185\u5b58\u5185\u5bb9\u7684\u5927\u5c0f="
    ...
    invoke-virtual {v9}, Lcom/netease/download/downloader/DownloadParams;->getByteBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v8, v9, v10, v5, v11}, Lcom/netease/download/util/SpUtil;->setString(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual/range {v17 .. v22}, Lcom/netease/download/util/SpUtil;->setLong(Ljava/lang/Object;Ljava/lang/String;JZ)V
    ...
    const-string v3, "DownloadAllCore [download_core] [\u5185\u5b58\u56de\u8c03\u6a21\u5f0f] md5Correct="
    ...
    invoke-virtual {v2, v7, v8}, Lcom/netease/download/downloader/TaskHandleOp;->addTaskDownloadFileVerifySizes(J)V
    ...
    const-string v3, "final download result="
    ...
    invoke-virtual {v4, v2, v3}, Lcom/netease/download/downloader/FileHandle;->setPatchDlspeed(D)V
