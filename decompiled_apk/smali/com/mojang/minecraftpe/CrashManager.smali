...
.method private handleUncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    const-string v1, "In handleUncaughtException()"
...
.method private uploadCrashFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, " more time(s) after "
...
.method private static uploadDump(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/util/Pair;
    ...
    const-string v2, "CrashManager: sentry parameters: "
    ...
    const-string v3, "upload_file_minidump"

    .line 293
    new-instance v4, Lorg/apache/http/entity/mime/content/FileBody;

    invoke-direct {v4, p0}, Lorg/apache/http/entity/mime/content/FileBody;-><init>(Ljava/io/File;)V

    invoke-virtual {p1, v3, v4}, Lorg/apache/http/entity/mime/MultipartEntity;->addPart(Ljava/lang/String;Lorg/apache/http/entity/mime/content/ContentBody;)V
    ...
    invoke-direct {v4, p3}, Lorg/apache/http/entity/mime/content/StringBody;-><init>(Ljava/lang/String;)V
    ...
    const-string v1, "CrashManager: Executed dump file upload with no exception: "
    ...
    const-string v1, "CrashManager: Error uploading dump file: "
...
.method private uploadException(Ljava/io/File;)Landroid/util/Pair;
    ...
    const-string v3, "CrashManager: reading exception file at "
