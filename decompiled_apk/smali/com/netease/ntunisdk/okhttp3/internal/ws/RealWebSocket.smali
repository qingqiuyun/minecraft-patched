...
.method public initReaderAndWriter(Ljava/lang/String;Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    invoke-static {p1, v1}, Lcom/netease/ntunisdk/okhttp3/internal/Util;->threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
...
.method writeOneFrame()Z
    ...
    :cond_5
    instance-of v2, v4, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket$Message;

    if-eqz v2, :cond_6

    move-object v2, v4

    check-cast v2, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket$Message;

    iget-object v2, v2, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket$Message;->data:Lcom/netease/ntunisdk/okio/ByteString;

    check-cast v4, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket$Message;

    iget v3, v4, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket$Message;->formatOpcode:I
    ...
    invoke-virtual {v0, v3, v4, v5}, Lcom/netease/ntunisdk/okhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lcom/netease/ntunisdk/okio/Sink;
    ...
    invoke-interface {v0, v2}, Lcom/netease/ntunisdk/okio/BufferedSink;->write(Lcom/netease/ntunisdk/okio/ByteString;)Lcom/netease/ntunisdk/okio/BufferedSink;
    ...
    :try_start_2
    iget-wide v3, p0, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket;->queueSize:J
    ...
    iput-wide v3, p0, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket;->queueSize:J
    ...
    :cond_6
    instance-of v2, v4, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket$Close;

    if-eqz v2, :cond_8

    check-cast v4, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket$Close;

    iget v2, v4, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket$Close;->code:I

    iget-object v4, v4, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket$Close;->reason:Lcom/netease/ntunisdk/okio/ByteString;

    invoke-virtual {v0, v2, v4}, Lcom/netease/ntunisdk/okhttp3/internal/ws/WebSocketWriter;->writeClose(ILcom/netease/ntunisdk/okio/ByteString;)V

    if-eqz v1, :cond_7

    iget-object v0, p0, Lcom/netease/ntunisdk/okhttp3/internal/ws/RealWebSocket;->listener:Lcom/netease/ntunisdk/okhttp3/WebSocketListener;

    invoke-virtual {v0, p0, v3, v6}, Lcom/netease/ntunisdk/okhttp3/WebSocketListener;->onClosed(Lcom/netease/ntunisdk/okhttp3/WebSocket;ILjava/lang/String;)V
    :try_end_3
