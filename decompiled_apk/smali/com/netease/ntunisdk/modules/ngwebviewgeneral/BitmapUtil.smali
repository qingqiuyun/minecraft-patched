.class public Lcom/netease/ntunisdk/modules/ngwebviewgeneral/BitmapUtil;
...
.method public static createBitmap(Landroid/content/Context;Ljava/lang/Object;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v2, v0}, Lcom/netease/ntunisdk/modules/ngwebviewgeneral/BitmapUtil;->decodeStream(Landroid/content/Context;Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2, v0}, Lcom/netease/ntunisdk/modules/ngwebviewgeneral/BitmapUtil;->decodeFile(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 110
    :cond_5
    invoke-static {p0, p1, v0}, Lcom/netease/ntunisdk/modules/ngwebviewgeneral/BitmapUtil;->getBitmap(Landroid/content/Context;Ljava/lang/Object;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public static decodeFile(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    .line 46
    invoke-static {v0, p1, p2}, Lcom/netease/ntunisdk/modules/ngwebviewgeneral/BitmapUtil;->calculateInSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
...
.method public static decodeResource(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1}, Lcom/netease/ntunisdk/modules/ngwebviewgeneral/ui/ResIdReader;->getDrawableId(Landroid/content/Context;Ljava/lang/String;)I
...
.method private static getBitmap(Landroid/content/Context;Ljava/lang/Object;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, p2}, Lcom/netease/ntunisdk/modules/ngwebviewgeneral/BitmapUtil;->decodeStream(Landroid/content/Context;Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2}, Lcom/netease/ntunisdk/modules/ngwebviewgeneral/BitmapUtil;->decodeFile(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public static getImgSavePath(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 250
    invoke-static {}, Lcom/netease/ntunisdk/modules/ngwebviewgeneral/BitmapUtil;->isSDCardAvailable()Z
    ...
    .line 251
    invoke-static {p0}, Lcom/netease/ntunisdk/modules/ngwebviewgeneral/BitmapUtil;->getExternalFileDir(Landroid/content/Context;)Ljava/io/File;
...
.method public static saveBitmap(Landroid/graphics/Bitmap;Ljava/io/File;I)Z
    ...
    const-string v8, "gm_bridge BitmapUtil"
    ...
    .line 199
    :cond_3
    invoke-static {v0, p1}, Lcom/netease/ntunisdk/modules/ngwebviewgeneral/BitmapUtil;->writeFile(Ljava/io/ByteArrayOutputStream;Ljava/io/File;)Z
