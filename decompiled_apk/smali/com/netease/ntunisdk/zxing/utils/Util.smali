...
.method public static adaptNotch(Landroid/app/Activity;Z[Landroid/view/View;)V
    ...
    new-array v2, v0, [Lcom/netease/ntunisdk/zxing/notch/NotchDevice$NotchAffectView;

    :goto_1
    if-ge v1, v0, :cond_3

    .line 830
    new-instance v9, Lcom/netease/ntunisdk/zxing/notch/NotchDevice$NotchAffectView;
    ...
    invoke-virtual {p1, p0, p2, v2}, Lcom/netease/ntunisdk/zxing/notch/NotchDevice;->justify(Landroid/content/Context;Landroid/view/Window;[Lcom/netease/ntunisdk/zxing/notch/NotchDevice$NotchAffectView;)V
...
.method private static decodeBitmap(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 935
    invoke-static {p0, p1, v0}, Lcom/netease/ntunisdk/zxing/utils/Util;->getScanResult(Landroid/graphics/Bitmap;II)Ljava/lang/String;
...
.method private static decodeUseZxing([III)Ljava/lang/String;
    .locals 6

    const-string v0, "UniQR sdk"

    const-string v1, "decodeUseZxing"
    ...
    .line 963
    sget-object v5, Lcom/netease/ntunisdk/zxing/client/android/DecodeFormatManager;->TWO_DIMENSIONAL_HINTS:Ljava/util/Map;

    invoke-virtual {v4, v5}, Lcom/google/zxing/MultiFormatReader;->setHints(Ljava/util/Map;)V

    .line 965
    new-instance v5, Lcom/google/zxing/RGBLuminanceSource;

    invoke-direct {v5, p1, p2, p0}, Lcom/google/zxing/RGBLuminanceSource;-><init>(II[I)V

    .line 966
    invoke-static {v4, v5}, Lcom/netease/ntunisdk/zxing/client/android/DecodeHandler;->decodeResultWithRGBSource(Lcom/google/zxing/MultiFormatReader;Lcom/google/zxing/RGBLuminanceSource;)Lcom/google/zxing/Result;
    ...
    const-string p2, "Zxing decodeUseZxing Exception :"
...
.method private static getScanResult(Landroid/graphics/Bitmap;II)Ljava/lang/String;
    .locals 9
    ...
    .line 948
    invoke-static {v0, p1, p2}, Lcom/netease/ntunisdk/zxing/utils/Util;->decodeUseZxing([III)Ljava/lang/String;
    ...
    invoke-static {p0, p2}, Lcom/netease/ntunisdk/base/UniSdkUtils;->d(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    const-string p1, "get YUV error"
...
.method public static setViewTextDirection(Landroid/view/View;I)V
    .locals 3
    ...
    .line 878
    invoke-static {v2, p1}, Lcom/netease/ntunisdk/zxing/utils/Util;->setViewTextDirection(Landroid/view/View;I)V
