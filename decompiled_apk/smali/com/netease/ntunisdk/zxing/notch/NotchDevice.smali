...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/netease/ntunisdk/zxing/notch/NotchDevice;
    ...
    new-array v2, v1, [Lcom/netease/ntunisdk/zxing/notch/NotchDevice;

    .line 28
    new-instance v3, Lcom/netease/ntunisdk/zxing/notch/NotchImplAndroidP;

    invoke-direct {v3}, Lcom/netease/ntunisdk/zxing/notch/NotchImplAndroidP;-><init>()V

    const/4 v4, 0x0

    aput-object v3, v2, v4

    new-instance v3, Lcom/netease/ntunisdk/zxing/notch/NotchImplHuaWei;

    invoke-direct {v3}, Lcom/netease/ntunisdk/zxing/notch/NotchImplHuaWei;-><init>()V
    ...
    new-instance v5, Lcom/netease/ntunisdk/zxing/notch/NotchImplMiui;

    invoke-direct {v5}, Lcom/netease/ntunisdk/zxing/notch/NotchImplMiui;-><init>()V

    aput-object v5, v2, v3

    const/4 v3, 0x3

    new-instance v5, Lcom/netease/ntunisdk/zxing/notch/NotchImplOppo;

    invoke-direct {v5}, Lcom/netease/ntunisdk/zxing/notch/NotchImplOppo;-><init>()V

    aput-object v5, v2, v3

    const/4 v3, 0x4

    new-instance v5, Lcom/netease/ntunisdk/zxing/notch/NotchImplVivo;

    invoke-direct {v5}, Lcom/netease/ntunisdk/zxing/notch/NotchImplVivo;-><init>()V

    aput-object v5, v2, v3

    const/4 v3, 0x5

    new-instance v5, Lcom/netease/ntunisdk/zxing/notch/NotchImplSamsung;

    invoke-direct {v5}, Lcom/netease/ntunisdk/zxing/notch/NotchImplSamsung;-><init>()V

    aput-object v5, v2, v3

    const/4 v3, 0x6

    new-instance v5, Lcom/netease/ntunisdk/zxing/notch/NotchImplNone;

    invoke-direct {v5}, Lcom/netease/ntunisdk/zxing/notch/NotchImplNone;-><init>()V
    ...
    .line 38
    invoke-virtual {v3, p0}, Lcom/netease/ntunisdk/zxing/notch/NotchDevice;->checkModel(Landroid/content/Context;)Z
    ...
    .line 39
    sput-object v3, Lcom/netease/ntunisdk/zxing/notch/NotchDevice;->sInstance:Lcom/netease/ntunisdk/zxing/notch/NotchDevice;
