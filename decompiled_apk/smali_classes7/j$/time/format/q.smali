...
# direct methods
.method constructor <init>(Lj$/time/Instant;Lj$/time/format/a;)V
    .locals 9
    ...
    invoke-virtual {p1, v1}, Lj$/time/Instant;->v(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v2}, Lj$/time/Instant;->v(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v5}, Lj$/time/Instant;->f(Lj$/time/temporal/r;)Z
    ...
    .line 164
    invoke-interface {v3, p1}, Lj$/time/chrono/n;->l(Lj$/time/temporal/o;)Lj$/time/chrono/b;
    ...
    invoke-virtual {p1, v7}, Lj$/time/Instant;->f(Lj$/time/temporal/r;)Z
    ...
    invoke-direct {v0, v4, p1, v3, v2}, Lj$/time/format/p;-><init>(Lj$/time/chrono/b;Lj$/time/Instant;Lj$/time/chrono/n;Lj$/time/x;)V
...
.method final e(Lj$/time/temporal/r;)Ljava/lang/Long;
    ...
    .line 308
    :cond_0
    invoke-interface {v1, p1}, Lj$/time/temporal/o;->s(Lj$/time/temporal/r;)J
...
.method final f(Lj$/time/format/b;)Ljava/lang/Object;
    .locals 4

    .line 287
    iget-object v0, p0, Lj$/time/format/q;->a:Lj$/time/temporal/o;

    invoke-interface {v0, p1}, Lj$/time/temporal/o;->v(Lj$/time/temporal/t;)Ljava/lang/Object;
