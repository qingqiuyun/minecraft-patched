...
.method validate(Ljava/lang/String;)Lorg/jose4j/jwt/consumer/ErrorCodeValidator$Error;
    ...
    .line 49
    :cond_1
    iget-object v2, p0, Lorg/jose4j/jwt/consumer/TypeValidator;->expectedType:Lorg/jose4j/jwt/consumer/TypeValidator$SimpleMediaType;
    ...
    invoke-virtual {v4, v3}, Lorg/jose4j/jwt/consumer/TypeValidator$SimpleMediaType;->match(Lorg/jose4j/jwt/consumer/TypeValidator$SimpleMediaType;)Z

    move-result v4

    if-eqz v4, :cond_2

    invoke-virtual {v3}, Lorg/jose4j/jwt/consumer/TypeValidator$SimpleMediaType;->getSubType()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lorg/jose4j/jwt/consumer/TypeValidator$SimpleMediaType;->getPrimaryType()Ljava/lang/String;
